...
pub type TransactionPool = sc_transaction_pool::BasicPool<Block, FullClient>;
...
pub struct NewFullBase {
	...
	pub transaction_pool: Arc<sc_transaction_pool::TransactionPoolHandle<Block, FullClient>>,
...
pub fn new_full_base(
	...
	let (network, system_rpc_tx, tx_handler_controller, network_starter, sync_service) =
		sc_service::build_network(sc_service::BuildNetworkParams {
			...
			warp_sync_params: Some(WarpSyncConfig::WithProvider(warp_sync)),
		})?;
