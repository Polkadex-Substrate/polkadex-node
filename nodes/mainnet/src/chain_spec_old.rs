...
use node_polkadex_runtime::WASM_BINARY;
...
fn udon_testnet_config_genesis() -> serde_json::Value {
	...
	for idx in 1..4 {
		...
		initial_authorities.push((
			...
			MixnetId::from(mxn.public().into_account()),
			BeefyId::from(bfy.public().into_account()),
		));
	}
...
pub fn udon_testnet_config() -> ChainSpec {
	...
	.with_genesis_config(udon_testnet_config_genesis())
	.with_boot_nodes(Vec::new())
	.with_telemetry_endpoints(TelemetryEndpoints::new(vec![(STAGING_TELEMETRY_URL.to_string(), 0)]).expect("Staging telemetry url is valid; qed"))
...
fn soba_testnet_genesis() -> serde_json::Value {
	let enclave_developement_account: AccountId =
		hex!["90ea3ff124ecd5732b9e95a85f6bf17258e735be5dd950351f4269956de0b976"].into();
	let orderbook_test_main_account: AccountId =
		hex!["6e9fb6f4db2e7efcb189ae75b98705976bf10a419edbce4b9a6a7a065826b82c"].into();
...
pub fn soba_testnet_config() -> ChainSpec {
	...
	.with_id("soba_testnet")
	.with_chain_type(ChainType::Local)
	.with_genesis_config(soba_testnet_genesis())
	.with_boot_nodes(Vec::new())
	//.with_genesis_config_preset_name(sp_genesis_builder::DEV_RUNTIME_PRESET)
	.build()
}
...
pub fn mainnet_testnet_config() -> ChainSpec {
	...
	.with_chain_type(ChainType::Live)
	.with_genesis_config(mainnet_genesis_constuctor())
	.with_boot_nodes(bootnodes)
	.with_telemetry_endpoints(TelemetryEndpoints::new(vec![(MAINNET_TELEMETRY_URL.to_string(), 0)]).expect("Staging telemetry url is valid; qed"))
...
pub fn testnet_genesis(
	...
	build_struct_json_patch!(RuntimeGenesisConfig {
		...
		babe: BabeConfig {
			...
			epoch_config: node_polkadex_runtime::BABE_GENESIS_EPOCH_CONFIG,
			..Default::default()
		},
