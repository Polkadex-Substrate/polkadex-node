...
curl http://localhost:10000 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy1"
...
curl http://localhost:10001 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy2"
...
curl http://localhost:10002 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy3"
