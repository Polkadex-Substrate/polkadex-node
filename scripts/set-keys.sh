...
curl http://localhost:9944 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/mixnet1"
curl http://localhost:9944 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy1"
...
curl http://localhost:9946 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/mixnet2"
curl http://localhost:9946 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy2"
...
curl http://localhost:9948 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/mixnet3"
curl http://localhost:9948 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/beefy3"
