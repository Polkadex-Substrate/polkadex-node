...
//pub const AGGREGATOR: &str = "http://localhost:8001"; // Updated to production URL
// pub const AGGREGATOR: &str = "http://orderbook-aggregator:8001"; // Updated to production URL
pub const AGGREGATOR: &str = "https://ob.aggregator.polkadex.ee";
